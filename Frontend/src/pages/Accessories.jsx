...
const products = [
  {
    id: 1,
    name: "CRICX Pro Cricket Kit Bag",
    category: "Bags",
    type: "Kit Bag",
    level: "Professional",
    price: 3999,
  ...
  {
    id: 2,
    name: "CRICX Elite Wheelie Cricket Bag",
    category: "Bags",
    type: "Wheelie Bag",
    level: "Professional",
    price: 4999,
    ...
    badge: "PRO",
    image:
      "https://images.unsplash.com/photo-1565026057447-bc90a3dceb87?auto=format&fit=crop&w=1200&q=90",
  },
  {
    id: 3,
    name: "CRICX Bat Cover Pro",
    category: "Bat Accessories",
    type: "Bat Cover",
    level: "Professional",
    price: 899,
    oldPrice: 1099,
  ...
  {
    id: 4,
    name: "CRICX Premium Bat Grip Pack",
    category: "Bat Accessories",
    type: "Bat Grip",
    level: "Match",
    price: 499,
  ...
  {
    id: 6,
    name: "CRICX Performance Sunglasses",
  ...
  {
    id: 7,
    name: "CRICX Training Water Bottle",
    category: "Training",
    type: "Bottle",
    level: "Training",
    price: 699,
...
export default function Accessories() {
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-950">
        ...
        <div className="relative flex min-h-[520px] items-center px-7 py-20 sm:px-12 lg:min-h-[620px] lg:px-20">
          ...
          <div className="max-w-2xl text-white">
            ...
            <p className="mt-7 max-w-xl text-base leading-7 text-zinc-300 sm:text-lg">
              The details that complete your cricket setup. Premium bags,
              bat accessories and performance essentials designed around the
              modern player.
            </p>
      ...
      <section className="mx-auto max-w-[1500px] px-5 pb-10 pt-20 lg:px-8">
        ...
        <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
          ...
          <p className="max-w-xl text-sm leading-6 text-zinc-500">
            From carrying your entire kit to perfecting the feel of your bat,
            CRICX accessories are made to make every session easier, cleaner
      ...
      <section className="mx-4 mb-24 overflow-hidden rounded-[30px] bg-zinc-950 sm:mx-6 lg:mx-8">
        ...
        <div className="grid min-h-[470px] lg:grid-cols-2">
          ...
          <div className="flex items-center px-7 py-16 sm:px-12 lg:px-20">
            ...
            <div>
              ...
              <p className="mt-6 max-w-md text-sm leading-6 text-zinc-400">
                Your bat, your kit, your routine. The right accessories make
                your preparation smoother and your game more focused.
              </p>
          ...
          <div className="relative min-h-[320px]">
            ...
            <img
              src="https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=1600&q=90"
              alt="Cricket kit bag"
      ...
      <section className="mx-auto max-w-[1500px] px-5 pb-24 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-sm leading-6 text-zinc-500">
            Accessories designed to improve organization, convenience and
            performance before, during and after the game.
          </p>
          ...
          {[
            {
              icon: Backpack,
              title: "SMART STORAGE",
              text: "Organize your cricket equipment with purpose-built compartments.",
            },
            {
              icon: Target,
              title: "PRECISION",
              text: "Performance accessories designed around the needs of players.",
            },
            {
              icon: Zap,
              title: "LIGHTWEIGHT",
              text: "Carry less unnecessary weight without compromising utility.",
            },
            {
              icon: ShieldCheck,
              title: "DURABLE",
              text: "Reliable materials made for repeated training and match use.",
            },
          ].map((item) => {
      ...
      {/* Statement */}
      <section className="bg-green-600 px-5 py-24">

        <div className="mx-auto max-w-5xl text-center">

          <p className="text-xs font-black tracking-[0.25em] text-green-950">
            COMPLETE YOUR CRICKET SETUP
          </p>

          <h2 className="mt-5 text-5xl font-black leading-[0.95] tracking-[-0.06em] text-white sm:text-7xl">
            READY FOR
            <br />
            THE NEXT
            <br />
          ...
          <p className="mx-auto mt-7 max-w-2xl text-sm leading-7 text-green-50">
            From your first practice to match day, CRICX accessories are built
            to keep your equipment organized and your preparation sharp.
          </p>
          ...
          <div className="grid gap-12 md:grid-cols-4">
            ...
            <div className="md:col-span-2">
              ...
              <p className="mt-6 max-w-sm text-sm leading-6 text-zinc-500">
                Premium cricket equipment and accessories designed for players
                who want to perform without compromise.
              </p>
            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-7 sm:p-10">
                ...
                <p className="mt-6 text-sm leading-6 text-zinc-500">
                  Premium CRICX accessory designed to make your cricket setup
                  more organized, practical and performance-ready.
                </p>
