...
const products = [
  {
    id: 1,
    name: "CRICX Titan Pro Cricket Helmet",
    category: "Helmets",
    type: "Helmet",
    level: "Professional",
    price: 5499,
  ...
  {
    id: 2,
    name: "CRICX Aero Steel Cricket Helmet",
    category: "Helmets",
    type: "Helmet",
    level: "Match",
    price: 3999,
  ...
  },
  {
    ...
    badge: "NEW",
    image:
      "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?auto=format&fit=crop&w=1200&q=90",
  },
  {
    id: 4,
    name: "CRICX Flex Thigh Guard",
    category: "Body Protection",
    type: "Thigh Guard",
    level: "Match",
    price: 1599,
  ...
  {
    id: 6,
    name: "CRICX Elite Abdominal Guard",
    category: "Body Protection",
  ...
  {
    id: 7,
    name: "CRICX Keeper Protection Set",
    category: "Protection Sets",
    type: "Complete Set",
    level: "Match",
    price: 4499,
    oldPrice: 5299,
    ...
    badge: "SAVE ₹800",
    image:
      "https://images.unsplash.com/photo-1531415074968-036ba1b575da?auto=format&fit=crop&w=1200&q=90",
  },
  {
    id: 8,
    name: "CRICX Ultimate Protection Kit",
    category: "Protection Sets",
    type: "Complete Set",
    level: "Professional",
    price: 7999,
...
const categories = [
  {
    title: "Helmets",
    subtitle: "Advanced head protection.",
    image:
      "https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=1400&q=90",
  },
  {
    title: "Body Protection",
    subtitle: "Stay protected at every pace.",
    image:
      "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?auto=format&fit=crop&w=1400&q=90",
  },
  {
    title: "Protection Sets",
    subtitle: "Complete match-day confidence.",
    image:
      "https://images.unsplash.com/photo-1531415074968-036ba1b575da?auto=format&fit=crop&w=1400&q=90",
  },
];
    ...
    <div className="min-h-screen bg-white text-zinc-950">
      ...
      <section className="relative mx-4 overflow-hidden rounded-[28px] bg-zinc-950 sm:mx-6 lg:mx-8">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=2200&q=90"
            alt="Cricket protection equipment"
        ...
        <div className="relative flex min-h-[520px] items-center px-7 py-20 sm:px-12 lg:min-h-[620px] lg:px-20">
          <div className="max-w-2xl text-white">
            ...
            <p className="mt-7 max-w-xl text-base leading-7 text-zinc-300 sm:text-lg">
              Elite protection engineered to keep you confident against pace,
              impact and pressure. Because your focus should stay on the next
              ball.
            </p>
      ...
      <section className="mx-auto max-w-[1500px] px-5 pb-10 pt-20 lg:px-8">
        <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
          ...
          <p className="max-w-xl text-sm leading-6 text-zinc-500">
            From advanced helmets to impact-ready body protection, CRICX
            protection equipment combines lightweight construction with
            dependable coverage.
          </p>
        </div>
      </section>
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-28">
              ...
              <div className="mb-8 border-t border-zinc-200 pt-7">
                ...
                <div className="space-y-3">
                  {["Professional", "Match", "Training"].map(
                    (level) => (
                      <label
                        key={level}
                        className="flex cursor-pointer items-center gap-3 text-sm text-zinc-600"
      ...
      {/* Protection Banner */}
      <section className="mx-4 mb-24 overflow-hidden rounded-[30px] bg-zinc-950 sm:mx-6 lg:mx-8">
        <div className="grid min-h-[480px] lg:grid-cols-2">
          <div className="flex items-center px-7 py-16 sm:px-12 lg:px-20">
            <div>
              <p className="mb-4 text-xs font-black tracking-[0.25em] text-green-500">
                ENGINEERED DEFENCE
              </p>
              ...
              <p className="mt-6 max-w-md text-sm leading-6 text-zinc-400">
                CRICX protection is designed around movement. Lightweight
                profiles and ergonomic construction give you freedom without
                sacrificing confidence.
              </p>

              <button className="mt-8 flex items-center gap-3 rounded-full bg-white px-7 py-4 text-sm font-bold text-black transition hover:bg-green-500">
                DISCOVER CRICX DEFENCE
                <ArrowRight size={17} />
              </button>
            </div>
          </div>
          ...
          <div className="relative min-h-[320px]">
            <img
              src="https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=1600&q=90"
              alt="Cricket protection"
              className="absolute inset-0 h-full w-full object-cover"
            />

            <div className="absolute inset-0 bg-gradient-to-r from-zinc-950 via-transparent to-transparent lg:bg-gradient-to-r" />
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-[1500px] px-5 pb-24 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-sm leading-6 text-zinc-500">
            Every layer has a purpose — from impact absorption to lightweight
            mobility and secure fit.
          </p>
        </div>
          ...
          {[
            {
              icon: ShieldCheck,
              title: "IMPACT READY",
              text: "Strategic cushioning helps absorb impact where you need it most.",
            },
            {
              icon: Zap,
              title: "LIGHTWEIGHT",
              text: "Low-profile construction keeps movement unrestricted.",
            },
            {
              icon: LockKeyhole,
              title: "SECURE FIT",
              text: "Stable designs stay comfortably positioned during play.",
            },
            {
              icon: Check,
              title: "MATCH TESTED",
              text: "Built around the movement and demands of modern cricket.",
            },
          ].map((item) => {
      ...
      {/* Safety Statement */}
      <section className="bg-green-600 px-5 py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-6 text-4xl font-black tracking-[-0.05em] text-white sm:text-5xl">
            CONFIDENCE AT EVERY BALL.
          </h2>

          <p className="mx-auto mt-5 max-w-2xl text-sm leading-6 text-green-50">
            Your equipment should let you focus on timing, technique and
            execution — not what happens if the ball comes too close.
          </p>
        </div>
      </section>
            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-7 sm:p-10">
                ...
                <p className="mt-6 text-sm leading-6 text-zinc-500">
                  Premium CRICX protection engineered for impact coverage,
                  comfort and unrestricted movement during high-intensity
                  cricket.
                </p>
